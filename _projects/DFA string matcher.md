---
layout: page
title: DFA string matcher and NFA to DFA converter
description: Construction on a DFA machine that can match string and an NFA to DFA concerter
img: assets/img/dfa.png
importance: 1
category: Other
---
...
<br>
{% include figure.html path="assets/img/nfa-dfa.png" title="nfa-dfa" class="img-fluid rounded z-depth-1" %}
<br>