...
<br>
{% include figure.html path="assets/img/digits.png" title="digits" class="img-fluid rounded z-depth-1" %}
<br>
...
<br>
{% include figure.html path="assets/img/mnist-table.png" title="table" class="img-fluid rounded z-depth-1" %}
<br>
The following plot shows the cost function output in each epoch of training the ann:
<br>
{% include figure.html path="assets/img/plt1.png" title="plot1" class="img-fluid rounded z-depth-1" %}
<br>
