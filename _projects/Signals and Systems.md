...
<br>
{% include figure.html path="assets/img/convolve1.png" title="convolve" class="img-fluid rounded z-depth-1" width=300 %}
{% include figure.html path="assets/img/convolve2.png" title="convolve" class="img-fluid rounded z-depth-1" width=300 %}
<br>
...
{% include figure.html path="assets/img/ft2.png" title="ft" class="img-fluid rounded z-depth-1" width=200 %}
{% include figure.html path="assets/img/ft3.png" title="ft" class="img-fluid rounded z-depth-1" width=200 %}
{% include figure.html path="assets/img/ft4.png" title="ft" class="img-fluid rounded z-depth-1" width=200 %}
<br>
